...
export function getVendorPrefixes(domSupport:boolean, win:any) {
  const prefixes = {
...
export function getVendorPrefixedEventName(eventName:'animationend' | 'transitionend') {
...
export function getTransitionName(transitionName?:string | {
  [key:string] : string
